...
Import-StartLayout -LayoutPath \\ulbassdat\install\Reestr\win_tweak\sc\win_10_Startlayout_NewUser.xml -MountPath "C:\"
}
#############################################################
...
Copy-Item -Path "\\ulbassdat\install\Reestr\win_tweak\sc\start2.bin" -Destination "%SystemDrive%\Users\Default\AppData\Local\Packages\Microsoft.Windows.StartMenuExperienceHost_cw5n1h2txyewy\LocalState\start2.bin"
}
